...
export const exercises: ExerciseDefinition[] = [
  {
    ...
    chapter: 'Chapter 1: Warm the Engine',
    narrative: 'Ease into motion. Let your knee find its rhythm.',
    mode: 'timer',
    sets: 5,
    durationSeconds: 60,
    restSeconds: 25,
  ...
  },
  {
    ...
    chapter: 'Chapter 2: Awaken the Quads',
    narrative: 'Controlled extension. Feel the muscle fire.',
    mode: 'timer',
    sets: 3,
    durationSeconds: 60,
    restSeconds: 20,
  ...
  },
  {
    ...
    chapter: 'Chapter 3: Build Foundation',
    narrative: 'Leg fully extended. Steady and strong.',
    mode: 'reps',
    sets: 5,
    reps: 20,
    restSeconds: 20,
  ...
  },
  {
    id: 'stepups',
    title: 'Step-Ups',
    chapter: 'Chapter 4: Rise Up',
    narrative: 'Step by step, your quads grow stronger.',
    mode: 'timer',
    sets: 3,
    durationSeconds: 60,
    restSeconds: 20,
  ...
  },
  {
    ...
    chapter: 'Chapter 5: Inner Strength',
    narrative: 'Control the movement. Feel the adductors engage.',
    mode: 'reps',
    sets: 3,
    reps: 15,
    restSeconds: 20,
  ...
  },
  {
    ...
    chapter: 'Chapter 6: Deep Activation',
    narrative: 'Hold. Breathe. Let the muscle do the work.',
    mode: 'holds',
    sets: 10,
    holdSeconds: 15,
    relaxSeconds: 10,
