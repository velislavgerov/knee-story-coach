      ...
      <div className="relative z-10 max-w-md w-full text-center space-y-8 cinematic-enter">
        ...
        <div className="glass-panel p-6 space-y-3">
          ...
          <div className="grid grid-cols-2 gap-4">
            <div>
              <p className="text-3xl font-display font-light text-foreground">{mins}<span className="text-lg text-muted-foreground/50">m</span> {secs}<span className="text-lg text-muted-foreground/50">s</span></p>
        ...
        {!logged ? (
          <div className="glass-panel p-6 space-y-4 text-left">
            <h2 className="text-xs font-medium uppercase tracking-widest text-muted-foreground/60">Quick log <span className="text-xs normal-case font-light">(optional)</span></h2>
            <div>
            ...
            <div className="flex gap-2">
              <button onClick={handleLog} className="flex-1 py-2.5 rounded-xl bg-primary/90 text-primary-foreground font-light text-sm flex items-center justify-center gap-1.5 transition-all duration-300 hover:bg-primary">
                <Check className="w-4 h-4" /> Save
              </button>
              <button onClick={() => setLogged(true)} className="py-2.5 px-4 rounded-xl bg-secondary/60 text-secondary-foreground text-sm font-light transition-colors duration-300 hover:bg-secondary">
                Skip
              </button>
            </div>
          </div>
